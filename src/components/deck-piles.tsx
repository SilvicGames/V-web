...
export function DeckPiles({ decks }: { decks: Decks }) {
  return (
    <div className="flex w-full h-full flex-row md:flex-col items-center justify-around md:justify-between gap-1 sm:gap-2 md:gap-4 rounded-lg bg-secondary/40 p-2 md:p-4 shadow-inner">
